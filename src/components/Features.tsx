export const BasicFeatures: React.FC = () => (
  <section className="bg-gray-100 text-base py-20">
    <div className="container mx-auto px-4">
      <p className="m-0 mb-8 text-center text-4xl font-bold text-gray-800">
        Our Features
      </p>
          ...
          <div className="overflow-hidden rounded-lg bg-white shadow-lg">
            <div className="p-6">
              <div className="mb-4 flex items-center">
                ...
                <p className="m-0 text-xl font-bold">Customizable</p>
              </div>
...
export const AlternateFeatures: React.FC = () => (
  <section className="bg-white text-base py-20">
    <div className="container mx-auto px-4">
      <p className="m-0 mb-8 text-center text-4xl font-bold text-gray-800">
        Key Features
      </p>
      ...
      <div className="flex flex-col-reverse flex-wrap md:flex-row">
        <div className="mb-8 w-full px-4 md:mb-0 md:w-1/2">
          <div className="rounded-lg bg-gray-100 p-6">
            <p className="m-0 mb-4 text-2xl font-bold text-gray-800">
              Responsive Design
            </p>
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1  gap-8">
        <div className="mb-8 flex items-center">
          ...
          <div>
            <p className="m-0 mb-2 text-xl font-bold text-gray-800">
              Highly Customizable
            </p>
            <p className="m-0 text-gray-600">
...
export const FeatureswithBenefits: React.FC = () => (
  <section className="bg-gray-900 text-base py-20">
    <div className="container mx-auto px-4">
      <p className="m-0 mb-8 text-center text-4xl font-bold text-white">
        Key Features
      </p>
        ...
        <div className="mb-8 w-full px-4 md:w-1/2 ">
          <div className="rounded-lg bg-white p-6 shadow-lg">
            <div className="mb-4 flex items-center">
              ...
              <p className="m-0 text-xl font-bold">Utility-First CSS</p>
            </div>
            <p className="m-0 text-gray-600">
      ...
      <div className="mt-16">
        <p className="m-0 mb-6 text-2xl font-bold text-white">Benefits</p>
