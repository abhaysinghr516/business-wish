export const BasicTabs: React.FC = () => (
  <div>
    <ul className="flex border-b list-none ">
      ...
      <div className="mr-1">
        <div className=" cursor-pointer px-4 py-1 font-semibold text-gray-500 hover:text-gray-800">
          {" "}
          Tab 2{" "}
        </div>
      </div>
...
export const TabswithIcons: React.FC = () => (
  <div>
    <ul className="flex border-b">
      ...
      <div className="mr-1">
        <div className="cursor-pointer inline-flex items-center px-4 py-2 font-semibold text-gray-500 hover:text-gray-800">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
...
export const TabswithPill: React.FC = () => (
  <div>
    <ul className="flex">
      ...
      <div className="mr-1">
        <div className="cursor-pointer inline-block rounded-full px-4 py-2 font-semibold text-gray-500 hover:text-gray-800">
          {" "}
          Tab 2{" "}
        </div>
      </div>
...
export const TabswithBox: React.FC = () => (
  <div>
    <ul className="flex">
      ...
      <div className="mr-1">
        <div className="cursor-pointer inline-block rounded-t-lg border border-gray-300 px-4 py-2 font-semibold text-gray-500 hover:text-gray-800">
          {" "}
          Tab 2{" "}
        </div>
      </div>
