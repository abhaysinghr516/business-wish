export const SimpleCTA: React.FC = () => (
  <div className="bg-purple-50 py-12">
    <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
      <h2 className="m-0 mb-4 text-3xl font-bold">Join Us Today!</h2>
      <p className="m-0 mb-6 text-lg text-gray-800">
        Sign up now to get exclusive offers and updates.
      </p>
      <button className="focus:shadow-outline rounded-full bg-purple-500 px-6 py-2 font-bold text-white hover:bg-purple-600 focus:outline-none">
        Sign Up
      </button>
    </div>
  </div>
  ...
  <div className="bg-gray-100 py-12">
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
      <div className="rounded-lg bg-white p-6 shadow-lg">
        <h2 className="m-0 mb-4 text-2xl font-semibold text-gray-800">
          Get Started Today!
        </h2>
    ...
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
      <div className="rounded-lg bg-white p-6 shadow-lg">
        ...
        <form className="flex flex-col sm:flex-row">
          ...
          <button
            type="submit"
            className="focus:shadow-outline rounded-r-lg bg-purple-500 px-6 py-2 font-bold text-white hover:bg-purple-600 focus:outline-none"
          >
            Subscribe
          </button>
        </form>
  ...
  <div className="bg-gray-100 py-12">
    <div className="mx-auto flex max-w-4xl flex-col-reverse items-center justify-between px-4 sm:px-6 md:flex-row lg:px-8">
      <div className="w-full pr-0 md:w-1/2 md:pr-4">
        <h2 className="m-0 mb-4 text-3xl font-bold text-gray-800">
          Get Started Today!
        </h2>
...
export const ImageOverlayCTA: React.FC = () => (
  <div className="relative bg-gray-800 py-24">
    ...
    <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
      <h2 className="m-0 mb-4 text-4xl font-bold text-white">
        Unlock Your Potential
      </h2>
      <p className="m-0 mb-6 text-lg text-gray-300">
        Join our community and explore endless opportunities.
      </p>
      <button className="focus:shadow-outline rounded-full bg-blue-500 px-8 py-3 font-bold text-white hover:bg-blue-600 focus:outline-none">
        Join Now
      </button>
    </div>
  </div>
