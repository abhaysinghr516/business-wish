...
export const FABSocialShare: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4">
      <button
        className="rounded-full p-3 bg-blue-600 text-white shadow-lg hover:bg-blue-700"
      ...
      {isOpen && (
        <div className="absolute bottom-16 right-0 bg-white shadow-lg rounded-lg p-2 flex flex-col space-y-2">
          <button
