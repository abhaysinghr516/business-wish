export const BasicSettingsPage: React.FC = () => (
  <div className="min-h-screen text-base bg-gray-100 p-8">
    <div className="max-w-xl mx-auto bg-white rounded-lg shadow-md p-6">
      <p className="text-2xl font-bold mb-6 text-gray-800">Settings</p>
      ...
      <div className="mb-6">
        <p className="text-xl font-semibold mb-4">Preferences</p>
...
export const SettingsPagewithTabs: React.FC = () => (
  <div className="bg-gray-100 text-base min-h-screen p-8">
    <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
      <p className="text-2xl font-bold mb-6">Settings</p>
