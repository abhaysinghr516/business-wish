...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: "bg-blue-500 hover:bg-blue-700 text-white dark:bg-blue-700 dark:hover:bg-blue-600",
    secondary: "bg-gray-300 hover:bg-gray-400 text-gray-800 dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white",
    outlined:
...
```jsx showLineNumbers
<div className="inline-flex rounded-md shadow-sm dark:shadow-gray-700" role="group">
