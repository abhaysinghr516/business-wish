---
title: Button
description: Highly customizable Tailwind button components and Tailwind button groups for Next.js and React. Features primary, ghost, and glass variants.
---
...
*Buttons are frequently used alongside [Dropdowns](/docs/components/dropdown) for hidden actions, or coupled with [Badges](/docs/components/badge) for notification displays.*
