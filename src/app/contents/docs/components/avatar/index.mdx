---
title: Avatar
description: Free, copy-pasteable Tailwind CSS Avatar component. Accessible, fully responsive, dark-mode ready, and customizable.
---
...
*Avatars combine perfectly with a [Badge](/docs/components/badge) for activity status, and are frequently used within [Dropdowns](/docs/components/dropdown) for account menus.*
