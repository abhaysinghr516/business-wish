...
description: Premium Tailwind bottom navigation bars optimized for mobile web apps, featuring active state micro-animations and glassmorphism.
---
...
*Looking for desktop routing? Explore our top [Header](/docs/components/header) designs or side [Sidebar](/docs/components/sidebar) structures.*
