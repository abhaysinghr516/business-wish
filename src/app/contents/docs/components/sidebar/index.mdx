---
title: Sidebar
description: Premium Tailwind sidebar components featuring glassmorphism, fluid collapsibility, and nested Tailwind CSS sidebar menus.
---
...
*A strong sidebar is often paired with a top-level [Header](/docs/components/header) for global actions, and frequently utilizes an [Avatar](/docs/components/avatar) at the bottom to represent the current user's profile.*
