---
title: Loader
description: Effortless, refined Tailwind loader components and Tailwind CSS spinners designed to keep your users engaged gracefully.
---

A custom **Tailwind loader** drastically improves perceived performance during data fetching. Rather than relying on default browser indicators, use these elegant **Tailwind CSS spinners**, bouncing dots, or pulsing rings to maintain your application's premium aesthetic even while waiting.

*Loaders are frequently embedded inside tracking [Buttons](/docs/components/button) during form submissions, while full layout loading states often benefit from a [Skeleton](/docs/components/skeleton).*
