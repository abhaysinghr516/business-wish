  ...
  return (
    <div className="w-full max-w-sm overflow-hidden rounded-xl bg-white shadow-lg">
      ...
      <div className="p-4">
        ...
        <p className="mb-4 text-sm text-gray-600">123 Modern Lane, Cityville, State 12345</p>
  ...
  return (
    <div className="w-full max-w-md overflow-hidden rounded-lg bg-white shadow-md">
      ...
      <div className="p-4">
        ...
        <h2 className="mb-2 text-xl font-bold text-gray-800">The Future of AI in Web Development</h2>
  ...
  return (
    <div className="w-full max-w-md rounded-lg bg-white shadow-md">
      <div className="p-4">
        ...
        <h2 className="mb-2 text-lg font-bold text-gray-800">Best practices for React hooks?</h2>
        <p className="mb-4 text-sm text-gray-600 line-clamp-2">
...
export default function PodcastCard() {
  return (
    <div className="w-full max-w-md rounded-lg bg-white shadow-md">
      ...
      <div className="p-4">
        <h2 className="mb-2 text-xl font-bold text-gray-800">The Web Dev Podcast</h2>
        <p className="mb-4 text-sm text-gray-600 line-clamp-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-medium text-gray-700">Sarah & Mike</span>
        </div>
      </div>
      <div className="flex items-center justify-between bg-gray-50 p-4">
        <button className="flex items-center justify-center w-1/2 rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700">
