---
title: Progress
description: Refined Tailwind progress bar components and Tailwind CSS loading indicators displaying operation status with smooth animations.
---
...
*Use a progress bar alongside a [File Upload](/docs/components/file-upload) zone to indicate transfer status, or swap it out for an indeterminate [Loader](/docs/components/loader) when you cannot calculate the exact duration.*
