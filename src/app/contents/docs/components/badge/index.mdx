---
title: Badge
description: Versatile Tailwind CSS badge components to show status indicators, counters, or labels with customizable styles and pill variations.
---

A **Tailwind CSS badge** (or **tailwindcss badge**) is heavily used to highlight statuses, notifications, and metadata. This collection features soft, flat designs with semantic coloring, dot indicators, and icon support—perfect for bringing attention to key information without overwhelming your UI.

*Badges pair excellently with [Avatars](/docs/components/avatar) for user status, or inside [Buttons](/docs/components/button) for notification counts.*
