---
title: Testimonial
description: High-converting Tailwind testimonial section layouts featuring beautiful typography and stunning Tailwind CSS reviews.
---
...
*Testimonials heavily rely on the [Avatar](/docs/components/avatar) component for social proof, and are typically placed in a [Card](/docs/components/card) grid directly following the primary [Hero](/docs/components/hero) section.*
