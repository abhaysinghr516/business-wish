---
title: Social Share
description: Elegant Tailwind social share buttons and a responsive Tailwind CSS share link component to maximize your content's reach.
---
...
*Our social share components are built using customized [Buttons](/docs/components/button) and can be triggered via a compact [Dropdown](/docs/components/dropdown) or a spacious [Modal](/docs/components/modal) dialog.*
