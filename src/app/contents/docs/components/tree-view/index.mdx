---
title: Tree View
description: Refined, animated component to display hierarchical data like a file system with smooth transitions, varied appearances, and clean typography.
---
