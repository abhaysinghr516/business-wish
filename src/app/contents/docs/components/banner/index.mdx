---
title: Banner
description: Free, copy-pasteable Tailwind CSS Banner component. Accessible, fully responsive, dark-mode ready, and customizable.
---
...
*Banners are often used alongside a [Header](/docs/components/header), or you can use an [Alert](/docs/components/alert) for smaller inline notifications.*
