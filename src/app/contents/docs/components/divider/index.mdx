---
title: Divider
description: Free, copy-pasteable Tailwind CSS Divider component. Accessible, fully responsive, dark-mode ready, and customizable.
---

A well-placed **Tailwind divider** creates breathing room and visual hierarchy in dense interfaces. Rather than a standard **Tailwind CSS hr**, these dividers include beautifully subtle gradients, vertical options, and icon-embedded separators designed with premium aesthetics in mind.

*Use dividers to segment information within a [Card](/docs/components/card), or to distinctly separate your main content area from the [Footer](/docs/components/footer).*
...
const CustomDividerwithIcon: React.FC = () => (
  <div className="mx-auto max-w-3xl p-8 text-sm dark:text-neutral-300">
