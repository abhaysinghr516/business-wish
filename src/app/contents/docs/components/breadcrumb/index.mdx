---
title: Breadcrumb
description: Elegant Tailwind breadcrumb components with collapsible dropdowns and animated separators to guide user navigation.
---
...
*Breadcrumbs pair naturally right below your primary [Header](/docs/components/header), or use [Pagination](/docs/components/pagination) for navigating multi-page lists.*
