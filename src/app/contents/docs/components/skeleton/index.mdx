...
description: Premium Tailwind skeleton loader and Tailwind CSS loading skeleton components to maintain layout integrity during data fetching.
---
...
*Pair a skeleton with complex layouts like a [Card](/docs/components/card) or [Avatar](/docs/components/avatar), or use a standard indeterminate [Loader](/docs/components/loader) for smaller inline actions.*
