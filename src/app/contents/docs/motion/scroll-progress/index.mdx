...
description: An interactive scroll tracker displaying window or container scroll position as a smooth horizontal gradient bar or circular indicator using Framer Motion.
---
