---
title: Split Text
description: Free, copy-pasteable Tailwind CSS & Framer Motion Split Text component. Accessible, fully responsive, dark-mode ready, and customizable.
---
...
*Split text pairs beautifully with [Fade In](/docs/motion/fade-in) wrappers, allowing you to sequence the entrance of a [Hero](/docs/components/hero) headline just before the surrounding content.*
