---
title: Dock
description: Free, copy-pasteable Tailwind CSS & Framer Motion Dock component. Accessible, fully responsive, dark-mode ready, and customizable.
---
...
*A dock is a visually impressive alternative to a standard [Bottom Navigation](/docs/components/bottom-navigation) bar, functioning perfectly as the primary interaction hub when grouped with elegant [Header](/docs/components/header) navigation.*
