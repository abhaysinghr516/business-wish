...
description: Free, copy-pasteable Tailwind CSS & Framer Motion Card Spotlight component. Accessible, fully responsive, dark-mode ready, and customizable.
---
...
*Combine this spotlight effect with a [Tilt Card](/docs/motion/tilt-card) for maximum interactivity, or use it to house standard static [Features](/docs/components/features).*
