---
title: Blur Reveal
description: Free, copy-pasteable Tailwind CSS & Framer Motion Blur Reveal component. Accessible, fully responsive, dark-mode ready, and customizable.
---
...
*Use a blur reveal on high-impact typography like a [Gradient Text](/docs/motion/gradient-text) hero header or to sequentially surface features in a [Card Spotlight](/docs/motion/card-spotlight) grid.*
