...
description: Free, copy-pasteable Tailwind CSS & Framer Motion Shimmer Button component. Accessible, fully responsive, dark-mode ready, and customizable.
---
...
*Use a shimmer button for your primary [Call to Action](/docs/components/call-to-action), or place one prominently in your top [Header](/docs/components/header) navigation.*
