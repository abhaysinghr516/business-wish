---
title: Scratch Card
description: An interactive scratch card utilizing HTML Canvas pixel composition and Framer Motion transitions, supporting images, gradients, and scratch progress trackers.
---
