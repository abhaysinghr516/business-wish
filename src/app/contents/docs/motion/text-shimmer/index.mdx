---
title: Text Shimmer
description: Free, copy-pasteable Tailwind CSS & Framer Motion Text Shimmer component. Accessible, fully responsive, dark-mode ready, and customizable.
---
...
*Use a text shimmer within a [Badge](/docs/components/badge) to highlight a "New" status, or wrap it around the primary label of a pricing [Card](/docs/components/card).*
