---
title: Word Rotate
description: Free, copy-pasteable Tailwind CSS & Framer Motion Word Rotate component. Accessible, fully responsive, dark-mode ready, and customizable.
---
...
*Word rotations are highly effective in a [Hero](/docs/components/hero) section headline, easily catching the eye without requiring the user to do any reading.*
