---
title: Fade In
description: Free, copy-pasteable Tailwind CSS & Framer Motion Fade In component. Accessible, fully responsive, dark-mode ready, and customizable.
---
...
*Wrap your entire [Hero](/docs/components/hero) section with a fade-in, or orchestrate the arrival of individual items within a [Blog List](/docs/pages/blog-list).*
