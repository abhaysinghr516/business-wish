...
Report generated on ${new Date().toLocaleString()}`;
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gray-950">
      <div className="bg-white dark:bg-black border-b border-slate-200 dark:border-gray-800">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <Link
            href="/tools"
            className="inline-flex items-center gap-2 text-slate-500 dark:text-gray-400 text-sm mb-4"
          >
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="bg-white dark:bg-black rounded-xl shadow-sm border border-slate-200 dark:border-gray-800 p-5 mb-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <Type className="h-4 w-4 text-slate-600 dark:text-gray-400" />
            ...
            <div className="flex gap-2">
              <button
                onClick={loadSample}
                className="flex items-center gap-2 px-3 py-1.5 text-xs bg-slate-50 dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-lg text-slate-700 dark:text-gray-300"
              >
                <Sparkles className="h-3 w-3" />
                Sample
              </button>
              <label className="flex items-center gap-2 px-3 py-1.5 text-xs bg-slate-50 dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-lg text-slate-700 dark:text-gray-300 cursor-pointer">
              ...
              {text && (
                <button
                  onClick={clearText}
                  className="flex items-center gap-2 px-3 py-1.5 text-xs text-slate-500 dark:text-gray-400 border border-slate-200 dark:border-gray-700 rounded-lg"
                >
          ...
          <textarea
            ...
            className="w-full h-48 px-3 py-3 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-gray-700 focus:ring-opacity-5 focus:border-slate-900 dark:focus:border-gray-600 resize-none text-slate-900 dark:text-gray-100"
          />

          {text && (
            <div className="flex justify-between items-center mt-3 pt-3 border-t border-slate-100 dark:border-gray-800">
              <div className="text-xs text-slate-500 dark:text-gray-400">
                Live analysis • {text.length} characters
              </div>
              <button
                onClick={generateReport}
                className="flex items-center gap-2 px-3 py-1.5 bg-slate-900 dark:bg-gray-50 text-white dark:text-black text-xs rounded-lg font-medium"
              >
        ...
        {stats && stats.words > 0 && (
          <>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
              <div className="bg-white dark:bg-black border border-slate-200 dark:border-gray-800 rounded-lg p-3 text-center">
                <div className="text-lg font-semibold text-slate-900 dark:text-gray-100 mb-0.5">
            ...
            <div className="bg-white dark:bg-black rounded-xl shadow-sm border border-slate-200 dark:border-gray-800 overflow-hidden">
                ...
                <div className="flex">
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-3 text-sm font-medium border-b-2 transition-colors ${
                      activeTab === "overview"
                        ? "border-slate-900 dark:border-gray-100 text-slate-900 dark:text-gray-100 bg-slate-50 dark:bg-gray-900"
                        : "border-transparent text-slate-600 dark:text-gray-400"
                    }`}
                  >
              ...
              <div className="p-6">
                {activeTab === "overview" && (
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                      <h3 className="text-sm font-medium text-slate-900 dark:text-gray-100 mb-4 flex items-center gap-2">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-gray-900 rounded-lg">
                          <Sparkles className="h-4 w-4 text-slate-500 dark:text-gray-400" />
                          <div>
                            <div className="text-sm font-medium text-slate-900 dark:text-gray-100">
                      ...
                      <div className="mt-6 p-4 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-800 rounded-lg">
                        <h4 className="text-sm font-medium text-slate-900 dark:text-gray-100 mb-3">
                          Text Composition
                        </h4>
                    ...
                    <div>
                      ...
                      {stats.mostCommonWords.length > 0 ? (
                        <div className="space-y-2">
                          {stats.mostCommonWords
                            ...
                            .map((item, index) => (
                              <div
                                key={item.word}
                                className="flex items-center justify-between p-2.5 bg-slate-50 dark:bg-gray-900 rounded-lg"
                              >
                                <div className="flex items-center gap-3">
                                  <span className="w-5 h-5 bg-slate-200 dark:bg-gray-700 rounded-full flex items-center justify-center text-xs font-medium text-slate-700 dark:text-gray-300">
                                    {index + 1}
                                  </span>
                                ...
                                <div className="flex items-center gap-2">
                                  <div className="w-12 bg-slate-200 dark:bg-gray-700 rounded-full h-1.5">
                                    <div
                                      className="bg-slate-600 dark:bg-gray-400 h-1.5 rounded-full"
                                      style={{
                                        width: `${
                                          (item.count /
                                  ...
                                  <span className="text-xs text-slate-600 dark:text-gray-400 w-6 text-right">
                                    {item.count}
                                  </span>
                                </div>
                              </div>
                        ...
                        <div className="text-center py-8">
                          <BookOpen className="h-8 w-8 text-slate-400 dark:text-gray-600 mx-auto mb-3" />
                ...
                {activeTab === "analysis" && (
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {stats.keywordDensity.map((item, index) => (
                          <div
                            key={item.word}
                            className="p-4 bg-slate-50 dark:bg-gray-900 rounded-lg"
                          >
                            ...
                            <div className="w-full bg-slate-200 dark:bg-gray-700 rounded-full h-2">
                              <div
                                className="bg-slate-600 dark:bg-gray-400 h-2 rounded-full"
                                style={{
                                  width: `${Math.min(
                                    100,
                                    (item.density / 5) * 100
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      <div className="p-4 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-800 rounded-lg">
                        <h4 className="text-sm font-medium text-slate-900 dark:text-gray-100 mb-3">
                          Word Distribution
                        </h4>
                ...
                {activeTab === "readability" && (
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 gap-6">
                      <div className="p-5 bg-white dark:bg-black border border-slate-200 dark:border-gray-800 rounded-lg">
                        <h4 className="text-sm font-medium text-slate-900 dark:text-gray-100 mb-4 flex items-center gap-2">
                    ...
                    <div className="p-5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 rounded-lg border border-blue-200 dark:border-blue-800">
                      <h4 className="text-sm font-medium text-slate-900 dark:text-gray-100 mb-4 flex items-center gap-2">
                        <Target className="h-4 w-4" />
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                          <div className="font-medium text-slate-800 dark:text-gray-200 mb-2">
                            Sentence Length
                          </div>
        ...
        {!stats?.words && (
          <div className="text-center py-16 bg-white dark:bg-black rounded-xl shadow-sm border border-slate-200 dark:border-gray-800">
            <div className="w-16 h-16 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-gray-800 dark:to-gray-900 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <FileText className="h-8 w-8 text-slate-600 dark:text-gray-400" />
            </div>
            ...
            <button
              onClick={loadSample}
              className="inline-flex items-center gap-2 px-4 py-2 bg-slate-900 dark:bg-gray-50 text-white dark:text-black text-sm rounded-lg font-medium"
            >
        ...
        <div className="mt-8 bg-white dark:bg-black rounded-xl shadow-sm border border-slate-200 dark:border-gray-800 p-6">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-gray-100 mb-5 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950 rounded-lg border border-green-200 dark:border-green-800">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="font-medium text-slate-800 dark:text-gray-200">
                  Readability
                </h4>
              </div>
              <ul className="text-sm text-slate-600 dark:text-gray-400 space-y-1.5">
