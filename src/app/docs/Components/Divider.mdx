...
import { BasicDivider, HorizontalDivider, DashedDivider, VerticalDivider, CustomDividerwithIcon, GradientDivider } from '../../../components/Divider'
...
<BasicDivider />
  ...
  <CodeBlock
      codeHtml={`<div class="mx-auto max-w-screen-xl p-6">
  Section
  <div class="my-4 border-t border-gray-300"></div>
  Section
</div>`}
codeJsx={`<div className="mx-auto max-w-screen-xl p-6">
  Section
...
<HorizontalDivider />
  ...
  <CodeBlock
      codeHtml={`<div class="mx-auto text-base max-w-screen-xl p-6">
    Section
  ...
  codeJsx={`<div className="mx-auto text-base max-w-screen-xl p-6">
    Section
...
<GradientDivider />
  ...
  <CodeBlock
      codeHtml={`<div class="mx-auto max-w-screen-xl p-6">
  Section
  <div class="my-4 h-0.5 rounded-full bg-gradient-to-r from-purple-500 to-pink-500"></div>
  Section
</div>`}
codeJsx={`<div className="mx-auto max-w-screen-xl p-6">
  Section
